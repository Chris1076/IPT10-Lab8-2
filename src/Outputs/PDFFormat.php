...
class PDFFormat implements ProfileFormatter
{
    ...
    public function setData($profile)
    {
        ...
        $this->pdf->Image($_ENV['FOUNDER_JPG'],65,10,0, 0, 'JPG');
        $this->pdf->SetFont('Times', 'B', 14);
        $this->pdf->Cell(0, 10, $profile->getFullName(), 0, 1, 'C');
        $this->pdf->SetFont('Helvetica', '', 12);
        $this->pdf->MultiCell(175, 10, $profile->getParagraph1(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph2(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph3(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph4(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph5(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph6(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph7(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph8(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph9(), 0);
        $this->pdf->Ln();
        $this->pdf->MultiCell(175, 10, $profile->getParagraph10(), 0);
